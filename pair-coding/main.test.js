describe("Tests for checkout, check that it", function() {
  it('creates a new instance of checkout when constructor is called', function () {
    let co = new Checkout();
    expect(typeof co).toBe('object');
    expect(typeof co.scan).toBe('function');
  })

  it('scans the item, adds the item to the basket and the price to the subtotal', function() {
  ...
  it('can keep track of many items added to the subtotal and basket', function () {
  ...
  it('can apply discounts when total is called', function() {
  ...
  it('still works even if there are no discounts to apply', function () {
  ...
  it('can remove an item from the basket and subtotal before total is called', function () {
